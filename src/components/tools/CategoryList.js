...
import { deleteData } from './../../store/actions/categoryActions';
                                        ...
                                        <tbody>
                                            {loading ?
                                                <tr>
                                                    ...
                                                    <tr key={item.id}>
                                                        <td>
                                                            <Link className="btn btn-dark btn-sm mx-2" to={`/category/edit/${item.id}`}>
...
export default connect(null, { deleteData })(CategoryList)