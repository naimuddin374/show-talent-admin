...
import { rejectData } from '../../store/actions/postCommentActions';
import { Form, Row, Button, Modal } from 'react-bootstrap';
import Loading from '../layout/Loading';


class PostCommentReject extends Component {
    state = {
...
export default connect(null, { rejectData })(PostCommentReject);